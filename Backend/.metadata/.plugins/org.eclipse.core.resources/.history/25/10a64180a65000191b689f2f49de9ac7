...
import com.capsule.TaskTracker.component.UserControllerRest;
...
public class UserControllerTest {
	...
	public void retrieveUserNegTest() throws Exception{
		...
		System.out.println(result.getResponse());
		String expected = "{\"userId\":0,\"firstName\":null ,\"lastName\": null,\"employeeId\":0,\"projectId\":0 ,\"taskId\":0}";
		JSONAssert.assertEquals(expected, result.getResponse()
				.getContentAsString(), false);
	}
	...
	public void createUserTest() throws Exception {
		Mockito.when(userService.createUser(Mockito.anyObject())).thenReturn(true);
		RequestBuilder requestBuilder = MockMvcRequestBuilders
										.post("/addUser")
										.accept(MediaType.APPLICATION_JSON)
										.content(exampleJson)
...
//		assertEquals(true, response.getStatus());
	...
	public void updateUserTest() throws Exception {
		Mockito.when(userService.updateUser(Mockito.anyObject())).thenReturn(true);
		RequestBuilder requestBuilder = MockMvcRequestBuilders
										.put("/edituser")
										.accept(MediaType.APPLICATION_JSON)
										.content(exampleJson)
