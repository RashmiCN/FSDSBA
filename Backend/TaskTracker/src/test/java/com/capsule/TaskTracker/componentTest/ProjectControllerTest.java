...
//				.getContentAsString(), false);
	...
	public void createProjectTest() throws Exception {
		Mockito.when(projectService.createProject(Mockito.anyObject())).thenReturn(project);
		RequestBuilder requestBuilder = MockMvcRequestBuilders
										.post("/addproject")
										.accept(MediaType.APPLICATION_JSON)
										.content(exampleJson)
	...
	public void updateProjectTest() throws Exception {
		Mockito.when(projectService.updateProject(Mockito.anyObject())).thenReturn(true);
		RequestBuilder requestBuilder = MockMvcRequestBuilders
										.put("/editproject")
										.accept(MediaType.APPLICATION_JSON)
										.content(exampleJson)
